...
io.write('\27[0;31m\n ارسل لي توكن البوت الان 𖣘━┅┄⟞⟦𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 ⟧⟝┄┉━𖣘\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m𖣘━┅┄⟞⟦𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 ⟧⟝┄┉━𖣘\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m𖣘━┅┄⟞⟦𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 ⟧⟝┄┉━𖣘\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي 𖣘━┅┄⟞⟦𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 ⟧⟝┄┉━𖣘\n\27[0;33;49m')
...
io.write('\27[1;31m 𖣘━┅┄⟞⟦𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 ⟧⟝┄┉━𖣘 ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "𖣘━┅┄⟞⟦𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 ⟧⟝┄┉━𖣘𖣘━┅┄⟞⟦𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 ⟧⟝┄┉━𖣘"
echo "TG IS NOT FIND IN FILES BOT"
echo "𖣘━┅┄⟞⟦𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 ⟧⟝┄┉━𖣘 𖣘━┅┄⟞⟦𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 ⟧⟝┄┉━𖣘"
exit 1
fi
if [ ! $token ]; then
echo "𖣘━┅┄⟞⟦𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 ⟧⟝┄┉━𖣘 𖣘━┅┄⟞⟦𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 ⟧⟝┄┉━𖣘"
...
token = sudos.token 
--- start functions 𖣘━┅┄⟞⟦𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 ⟧⟝┄┉━𖣘
--------------------------------------------------------------------------------------------------------------
...
sudo_users = {SUDO,1804119251,1735935275,1853574370,1885646062,1785825545}   
...
var = 'مالك السورس'
elseif tonumber(user_id) == tonumber(1992293723) then
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then
...
local UserName = (data.username_ or "sezr_su")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼˹《𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑》˼")  
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or ' سيــــٓــزر') 
local DRAGON_Msg = { 
...
local sezr_su = database:get(bot_id..'text:ch:user')
if sezr_su then
send(msg.chat_id_, msg.id_,'['..sezr_su..']')
else
...
local Text = ' 🇪🇬تم ارسال الملصق من 𖣘━┅┄⟞⟦𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 ⟧⟝┄┉━𖣘\n - '..Name
...
{'الاخبار','تصميمات  سيــــٓــزر','مميزات'},
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس☎️', url="t.me/s_e_z_r0"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/surccesezr/5=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == '𖣘━┅┄⟞⟦𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 ⟧⟝┄┉━𖣘' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس سيــــٓــزر ادخل وتابع الجديد](https://t.me/surccesezr)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹《𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑》˼', url="https://t.me/surccesezr"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/surccesezr=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '━┅┅┄⟞⟦𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑⟧⟝┄┉┉━' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس سيــــٓــزر ادخل وتابع الجديد](https://t.me/surccesezr)
]] 
keyboard = {}  
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/surccesezr
=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'معلومات الكيبورد' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](https://t.me/surccesezr)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="https://t.me/surccesezr"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
usertext = '\n 🇪🇬 الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'sezr_su')..')'
status  = '\n 🇪🇬 تم ترقيته مطور'
...
usertext = '\n 🇪🇬 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'sezr_su')..')'
status  = '\n 🇪🇬 تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🇪🇬 الـعـضو   ⇇[↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'sezr_su')..') \n 🇪🇬 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or " سيــــٓــزر")
...
send(msg.chat_id_,0," 🇪🇬 الـعـضو  : {["..data.first_name_.."](T.ME/sezr_su)}\n 🇪🇬 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 🇪🇬 عذرا  ⇇{["..data.first_name_.."](T.ME/sezr_su)}\n 🇪🇬 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[ 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
[🎗╎ 𝚆𝚎𝚕𝚌𝚘𝚖𝚎 𝚍𝚎𝚊𝚛 ](http://https://t.me/surccesezr)
[🚶‍♂╎𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 ??𝙽 𝚃𝙴𝙻𝙶𝚁𝙰𝙼 ](http://https://t.me/surccesezr)
[ ☠╎ 𝚂𝚃𝚁𝙻𝚅𝙴 𝙵𝙾𝚁 𝚃??𝙴 𝙱𝙴𝚂𝚃 ](http://https://t.me/surccesezr)
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
•  𝖼𝗁 - [𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶](https://t.me/surccesezr)
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
]]
keyboard = {}
keyboard.inline_keyboard = {
{{text = ' ❨𝙰𝚂𝙰𝙻𝙸𝚈𝙰 🇪🇬❩',url="t.me/s_e_z_r0"}},
{{text = ' ❨𝚈𝙾𝚄𝚂𝚂𝙴𝙵 🇪🇬❩',url="t.me/P_X_U"}},
{{text = ' ❨𝙰𝙱𝙾 𝙰𝙻𝙼𝙰𝙶𝙳 🇪🇬❩',url="t.me/ABO_ELMAGD2"}},
{{text = '˹《𝐒𝐎𝐔??𝐂𝐄 𝐒𝐄𝐙𝐑》˼',url="https://t.me/surccesezr"}},
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
🇪🇬سعر التنصيب علي سورس سيــــٓــزر 
🇪🇬سعر التنصيب العادي 20جنيه فقط
🇪🇬للتواصل اتبع الازرار بالاسفل ⇓
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '�
��� 𝚃𝙾 𝚂𝙾𝚄𝚁??𝙴 𝚅𝙸𝙺𝙸𝙽𝙶](http://https://t.me/surccesezr)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹《𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑》˼ ', url="https://t.me/surccesezr"}}, 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
سيزر مبرمج سورس سيــــٓــزر للتواصل معه اتبع الزر الاسفل ⬇️💕. ❩](t.me/s_e_z_r0)]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨  𖣘• ⁽𝐒𝐄𝐙𝐑₎ •𖣘 ❩', url="t.me/s_e_z_r0"}},
{{text = '《𝙻𝚃𝚄𝙰𝚂𝙸𝙻 𝚂𝙾𝚄𝚁𝙲𝙴 》', url="t.me/ASALIYA_WABNE_BOT"}}, 
...
🇪🇬 خلفيات ← لعرض الميزه
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
🇪🇬 𝘾𝙃 - [˹《𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑》˼](https://t.me/surccesezr) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨  𖣘• ⁽𝐒𝐄𝐙𝐑₎ •𖣘 ❩', url="t.me/s_e_z_r0"}},
{{text = '❨  𖣘• ⁽𝐒𝐄𝐙𝐑₎ •𖣘 ❩', url="https://t.me/surccesezr"}},
{{text = 'اضف البوت الي مجموعتك ✰ ', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/aslak8/26&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'العاب  سيــــٓــزر' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 🇪🇬 اهلا في قائمه الالعاب المتطوره سورس سيــــٓــزر 🇪🇬 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](https://t.me/surccesezr)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🇪🇬 تم تعطيل جلب الصوره ،\n 🇪🇬 تم قفل البوتات  ،\n 🇪🇬 تم قفل التكرار ،\n 🇪🇬 تم قفل الروابط ،\n 🇪🇬 تم قفل التوجيه ،\n 🇪🇬 تم قفل الملصقات ،\n 🇪🇬 تم قفل المتحركه ،\n 🇪🇬 تم قفل الفيديو ،\n 🇪🇬 تم قفل الفشار ،\n 🇪🇬 تم قفل الانلاين ،\n 🇪🇬 تم قفل تعديل المديا ،\n 🇪🇬 تم وضع التكرار  ،\n 🇪🇬 تم قفل الفارسيه  ،\n 🇪🇬 تم وضع الايدي بدون صوره ،n  \n 🇪🇬 تم تفعيل الحمايه  بواسطه ، [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'sezr_su')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  تم تعطيل الحمايه القصوه من قبل    [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'sezr_su')..')  ')
end,nil)   
end
if text == 'قفل الدردشه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:set(bot_id.."lock:text"..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 🇪🇬  مـن قبـل  ⇇[↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'sezr_su')..') \n 🇪🇬 تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🇪🇬  مـن قبـل  ⇇['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'sezr_su')..') \n 🇪🇬 تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_, " 🇪🇬 لا تسطيع حظر مرات سيزر عام")
return false 
end
...
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر مرات سيزر \n")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1853574370) then  
send(msg.chat_id_, msg.id_, " 🇪🇬 لا تسطيع كتم مرات سيزر عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1735935275) then  
...
if result.id_ == tonumber(1853574370) then
send(msg.chat_id_, msg.id_, " 🇪🇬 لا يمكنك كتم مرات سيزر \n")
return false 
end
if result.id_ == tonumber(1735935275) then
...
t = ' 🇪🇬 ملفات السورس سيــــٓــزر𖣘━┅┄⟞⟦𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 ⟧⟝┄┉━𖣘\n 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅🇪🇬𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘 \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if Get_info then
local TextS = "\n 🇪🇬 اهلا بك في متجر ملفات  سيــــٓــزر\n 🇪🇬 ملفات السورس 𖣘━┅┄⟞⟦𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 ⟧⟝┄┉━𖣘\n◤━───━🇪🇬𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n𖣘━┅┄⟞⟦𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 ⟧⟝┄┉━𖣘\n 🇪🇬 علامة تعني { ✔️ } ملف مفعل\n 🇪🇬 علامة تعني { ✖ } ملف معطل\n 🇪🇬 قناة سورس سيــــٓــزر𖣘━┅┄⟞⟦𝚂𝙾𝚄🇪🇬𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘\n".." 🇪🇬 [اضغط هنا لدخول](https://t.me/surccesezr) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 🇪🇬 عذرا الملف لايدعم سورس سيــــٓــزر\n") 
end
return false
end
...
if text == ("مسح قائمه  سيــــٓــزر") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 🇪🇬 تم مسح قائمه  سيــــٓــزر')
return false
end

if text == 'قائمه  سيــــٓــزر' and Sudo(msg) then
...
if #list == 0 then
t = " 🇪🇬 لا يوجد احد في قائمه  سيــــٓــزر"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع  سيــــٓــزر") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local sezr_su = database:get(bot_id..'text:ch:user')
if sezr_su then
send(msg.chat_id_, msg.id_,'['..sezr_su..']')
...
if text and text:match("^رفع  سيــــٓــزر@(.*)$") and Sudo(msg) then
local username = text:match("^رفع  سيــــٓــزر@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local sezr_su = database:get(bot_id..'text:ch:user')
if sezr_su then
send(msg.chat_id_, msg.id_,'['..sezr_su..']')
...
if text and text:match("^رفع  سيــــٓــزر(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع  سيــــٓــزر(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local sezr_su = database:get(bot_id..'text:ch:user')
if sezr_su then
send(msg.chat_id_, msg.id_,'['..sezr_su..']')
...
if text == ("تنزيل  سيــــٓــزر") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local sezr_su = database:get(bot_id..'text:ch:user')
if sezr_su then
send(msg.chat_id_, msg.id_,'['..sezr_su..']')
...
if text and text:match("^تنزيل  سيــــٓــزر@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل  سيــــٓــزر@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local sezr_su = database:get(bot_id..'text:ch:user')
if sezr_su then
send(msg.chat_id_, msg.id_,'['..sezr_su..']')
...
if text and text:match("^تنزيل  سيــــٓــزر(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل  سيــــٓــزر(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local sezr_su = database:get(bot_id..'text:ch:user')
if sezr_su then
send(msg.chat_id_, msg.id_,'['..sezr_su..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🇪🇬 لعضو  ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'sezr_su')..')'
status  = '\n 🇪🇬 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 🇪🇬 الـعـضو   ⇇'..userid..''
...
t = "\n 🇪🇬 قائمه زوجات الجروب \n 🇪🇬═───═❲[˹《𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑》˼ ](https://t.me/surccesezr)❳═───═🇪🇬\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🇪🇬 العضــو  ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'sezr_su')..')'
...
' }\nء⧬━┅┅┄⟞❲[𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙸𝙺𝙸𝙽𝙶](https://t.me/surccesezr)❳⟝┄┉┉━⧬'..
'\n 🇪🇬  علامة ال {✓} تعني مفعل'..
'\n 🇪🇬  علامة ال {✘} تعني معطل'..
'\nء𖣘━┅┄⟞⟦𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 ⟧⟝┄┉━𖣘'..
'\n'..' 🇪🇬  امر صيح  ⇇{ '..kickme..
...
' }\n'..' 🇪🇬  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' 🇪🇬  الرفع  ⇇{ '..setadd..
' }\n'..' 🇪🇬  الحظر  ⇇{ '..banm..' }\n\n 🇪🇬═───═❲[˹《𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑》˼ ](https://t.me/surccesezr)❳═───═ 🇪🇬\n 🇪🇬 قناة سورس سيــــٓــزر𖣘━┅┄⟞⟦𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 ⟧⟝┄┉━𖣘\n [ ❲[˹《𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑》˼ ](https://t.me/surccesezr)❳](https://t.me/surccesezr) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'𖣘━┅┄⟞⟦𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 ⟧⟝┄┉━𖣘\nاضغط علي الاسم ليتم نسخه\n𖣘━┅┄⟞⟦𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑 ⟧⟝┄┉━𖣘ٴ\n 🇪🇬 ❲[˹《𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐙𝐑》˼ ](https://t.me/surccesezr)❳ 🇪🇬 ')
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 